...
- create BIDS compatible filenames or folder structures for raw or derivatives
  datasets (`bids.create_filename`, `bids.create_path`, `bids.util.mkdir`),
...
- implement reading / writing capabilities for the modality specific data format 
  that exist in BIDS (`.nii`, `.eeg`, `.ds`, `.fif`...)
