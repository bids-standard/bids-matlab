...
[![Binder-stable](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/bids-standard/bids-matlab/master?filepath=demos/notebooks/01_BIDS-Matlab_basics.ipynb)
[![Binder-dev](https://img.shields.io/badge/launch-binder_dev-blue.svg)](https://mybinder.org/v2/gh/bids-standard/bids-matlab/dev?filepath=demos/notebooks/01_BIDS-Matlab_basics.ipynb)
...
on the brainhack mattermost and / or our [google groups](https://groups.google.com/g/bids-matlab).
...
"branch": https://github.com/bids-standard/bids-matlab/tree/dev

Click [HERE](https://github.com/bids-standard/bids-matlab/archive/refs/heads/dev.zip) to download.
...
- generate human readable reports of the content of BIDS data with physio and events data,
...
A
[tutorial](https://github.com/bids-standard/bids-matlab/blob/master/demos/notebooks/01_BIDS-Matlab_basics.ipynb)
is available as a Jupyter Notebook and can be run interactively via
[Binder](https://mybinder.org/v2/gh/bids-standard/bids-matlab/master?filepath=demos/notebooks/01_BIDS-Matlab_basics.ipynb).
