...
* [ENH] remove checks for participants.tsv or samples.tsv in derivatives by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/666
* [ENH] sanitize entities in rename spec by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/679
* [ENH] Added modality retrieval from path by @nbeliy in https://github.com/bids-standard/bids-matlab/pull/656
* [ENH] add zero padding to entity labels / indices when passed as numbers by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/680
* [ENH] add support for BIDS MRS by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/718

### Fixed

* [FIX] Create valid participants and sessions tsv during dataset init #688 by @Remi-Gau
* [FIX] create valid participants and sessions tsv during dataset init by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/688
* [FIX] handle error for misshaped tsv by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/667
* [FIX] index modality at same level as sessions by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/681
* [FIX] set default empty modality for files with no entities by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/691
* [FIX] ignore 'na' as trial types when creating default models by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/709
* [FIX] Suppress warning when session is taken for modality when going schemaless by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/710
* [FIX] fix validation of F contrasts by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/711
* [FIX] handle rare case where intended for field is empty by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/716
...
* [FIX] do not create empty json when copying to derivatives by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/322
* [DOC] add orcid numbers to CITATION.CFF by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/337
* [INFRA] only run update schema on upstream repo by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/343
* [FIX] change download of moae demo dataset by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/351
* [FIX] Skip missing suffix subgroup by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/365
* [FIX] add test to catch error for invalid entities by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/367
* [FIX] add warning when indexing folder with invalid MATLAB structure name by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/366
* [DOC & ENH] update doc query and allow to query any BIDS entity by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/368
* [REF] Use JSON version of the schema by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/415
* [ENH] add NIRS support by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/433
* [FIX]  query with empty subject should return empty and not fail by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/455
* [FIX] fix spelling with codespell by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/457
* [FIX] make bids.copy strict by default by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/468
* [FIX] add try catch for rare errors on invalid bids datasets by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/471
* [FIX] cleaner handling of missing dependency by @nbeliy in https://github.com/bids-standard/bids-matlab/pull/473
* [FIX] do not index files that start with certain string by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/479
* [FIX] remove byte order mark from tsv file by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/556
* [FIX] handle nan and and datetimes when printing tables by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/605
* [MAINT] change to MIT license by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/653
* [MAINT] Drop `dev` branch by @Remi-Gau in https://github.com/bids-standard/bids-matlab/pull/654
